#!/usr/bin/env python3
"""
Land Lead Finder v74 — 100+ Acre Tracts  TN / AL / NC
=======================================================
Counties:
...
Usage:
  ...
  python3 land_lead_finder_v74.py
  python3 land_lead_finder_v74.py --min-acres 200 --top 50
"""
...
<title>Land Scout v74 · {run_ts}</title>
...
<div class="main-area">
  <div class="topbar">
    ...
    <div class="logo">LAND SCOUT <small>v74 · {run_ts}</small><span id="capNote" style="font-size:9px;color:var(--muted);margin-left:8px"></span></div>
...
def main():
    ...
    print("=" * 60)
    print(f"Land Lead Finder v74 — {run_ts}")
