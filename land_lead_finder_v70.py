#!/usr/bin/env python3
"""
Land Lead Finder v70 — 100+ Acre Tracts  TN / AL / NC
=======================================================
Counties:
...
Usage:
  ...
  python3 land_lead_finder_v70.py
  python3 land_lead_finder_v70.py --min-acres 200 --top 50
"""
...
<title>Land Scout v70 · {run_ts}</title>
...
<div class="main-area">
  <div class="topbar">
    ...
    <div class="logo">LAND SCOUT <small>v70 · {run_ts}</small><span id="capNote" style="font-size:9px;color:var(--muted);margin-left:8px"></span></div>
...
<td class="gps-cell" style="font-size:9px;line-height:1.4;white-space:nowrap;min-width:0">
  ...
  ${{d.winter_low != null ? '<span style="color:#93c5fd;font-size:10px">❄'+d.winter_low+'°</span>' : ''}}
</td>
...
function renderSavedList() {{
  ...
  entries.sort((a,b) => (_so[a[1].status]??9) - (_so[b[1].status]??9));
...
def main():
    ...
    ap.add_argument("--nc-counties", nargs="+",
                    default=["Cherokee","Clay","Graham","Haywood","Jackson","Macon","Madison","Mitchell","Swain","Yancey"])
    ...
    print("=" * 60)
    print(f"Land Lead Finder v70 — {run_ts}")
